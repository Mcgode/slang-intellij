...
public class SlangDeclarationModifierImpl extends ASTWrapperPsiElement implements SlangDeclarationModifier {

  public SlangDeclarationModifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SlangVisitor visitor) {
    visitor.visitDeclarationModifier(this);
  }
