...
public class SlangOldDeclaratorTtImpl extends ASTWrapperPsiElement implements SlangOldDeclaratorTt {

  public SlangOldDeclaratorTtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SlangOldVisitor visitor) {
    visitor.visitDeclaratorTt(this);
  }
