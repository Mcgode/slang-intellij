...
public class SlangPointerSpecifierImpl extends ASTWrapperPsiElement implements SlangPointerSpecifier {

  public SlangPointerSpecifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SlangVisitor visitor) {
    visitor.visitPointerSpecifier(this);
  }
