...
public class SlangAttributeIdentifierImpl extends ASTWrapperPsiElement implements SlangAttributeIdentifier {

  public SlangAttributeIdentifierImpl(@NotNull ASTNode node) {
    super(node);
  }
