...
public class SlangDeclarationStatementImpl extends ASTWrapperPsiElement implements SlangDeclarationStatement {

  public SlangDeclarationStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
