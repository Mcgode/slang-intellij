...
public class SlangAttributeParameterImpl extends ASTWrapperPsiElement implements SlangAttributeParameter {

  public SlangAttributeParameterImpl(@NotNull ASTNode node) {
    super(node);
  }
