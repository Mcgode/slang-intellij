...
public class SlangVariableIdentifierImpl extends ASTWrapperPsiElement implements SlangVariableIdentifier {

  public SlangVariableIdentifierImpl(@NotNull ASTNode node) {
    super(node);
  }
