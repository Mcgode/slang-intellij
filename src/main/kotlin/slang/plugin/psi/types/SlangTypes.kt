...
object SlangTypes {
    ...
    val ATTRIBUTE_SYNTAX_DECLARATION = SlangElementType("ATTRIBUTE_SYNTAX_DECLARATION")
    ...
    val EMPTY_DECLARATION = SlangElementType("EMPTY_DECLARATION")
    ...
    val GETTER_DECLARATION = SlangElementType("GETTER_DECLARATION")
    ...
    val HLSL_CBUFFER_DECLARATION = SlangElementType("HLSL_CBUFFER_DECLARATION")
    ...
    val HLSL_TBUFFER_DECLARATION = SlangElementType("HLSL_TBUFFER_DECLARATION")
    val IF_STATEMENT = SlangElementType("IF_STATEMENT")
    val IMPLEMENTING_DECLARATION = SlangElementType("IMPLEMENTING_DECLARATION")
    val IMPLICIT_CONVERSION_MODIFIER = SlangElementType("IMPLICIT_CONVERSION_MODIFIER")
    val IMPORT_DECLARATION = SlangElementType("IMPORT_DECLARATION")
    val INCLUDE_DECLARATION = SlangElementType("INCLUDE_DECLARATION")
    val INCLUDE_DIRECTIVE = SlangElementType("INCLUDE_DIRECTIVE")
    ...
    val MODULE_DECLARATION = SlangElementType("MODULE_DECLARATION")
    ...
    val PROPERTY_DECLARATION = SlangElementType("PROPERTY_DECLARATION")
    ...
    val REF_ACCESSOR_DECLARATION = SlangElementType("REF_ACCESSOR_DECLARATION")
    ...
    val SETTER_DECLARATION = SlangElementType("SETTER_DECLARATION")
    ...
    val UNDEF_DIRECTIVE = SlangElementType("UNDEF_DIRECTIVE")
    val USING_DECLARATION = SlangElementType("USING_DECLARATION")
        ...
        companion object {
            fun createElement(node: ASTNode?): PsiElement {
                when (node?.elementType) {
                    ...
                    ATTRIBUTE_SYNTAX_DECLARATION -> SlangAttributeSyntaxDeclarationImpl(node)
                    ...
                    EMPTY_DECLARATION -> return SlangEmptyDeclarationImpl(node)
                    ...
                    GETTER_DECLARATION -> return SlangGetterDeclarationImpl(node)
                    ...
                    HLSL_CBUFFER_DECLARATION -> return SlangHlslCBufferDeclarationImpl(node)
                    ...
                    HLSL_TBUFFER_DECLARATION -> return SlangHlslTBufferDeclarationImpl(node)
                    IF_STATEMENT -> return SlangIfStatementImpl(node)
                    IMPLEMENTING_DECLARATION -> return SlangImplementingDeclarationImpl(node)
                    IMPLICIT_CONVERSION_MODIFIER -> return SlangImplicitConversionModifierImpl(node)
                    IMPORT_DECLARATION -> return SlangImportDeclarationImpl(node)
                    INCLUDE_DECLARATION -> return SlangIncludeDeclarationImpl(node)
                    INCLUDE_DIRECTIVE -> return SlangIncludeDirectiveImpl(node)
                    ...
                    MODULE_DECLARATION -> return SlangModuleDeclarationImpl(node)
                    ...
                    PROPERTY_DECLARATION -> return SlangPropertyDeclarationImpl(node)
                    ...
                    REF_ACCESSOR_DECLARATION -> return SlangRefAccessorDeclarationImpl(node)
                    ...
                    SETTER_DECLARATION -> return SlangSetterDeclarationImpl(node)
                    ...
                    UNDEF_DIRECTIVE -> return SlangUndefDirectiveImpl(node)
                    USING_DECLARATION -> return SlangUsingDeclarationImpl(node)
