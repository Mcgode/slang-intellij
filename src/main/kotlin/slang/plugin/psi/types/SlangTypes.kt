...
object SlangTypes {
    ...
    val STATIC_MEMBER_TYPE_EXPRESSION = SlangElementType("STATIC_MEMBER_TYPE_EXPRESSION")
        ...
        companion object {
            fun createElement(node: ASTNode?): PsiElement {
                when (node?.elementType) {
                    ...
                    STATIC_MEMBER_TYPE_EXPRESSION -> return SlangStaticMemberTypeExpressionImpl(node)
